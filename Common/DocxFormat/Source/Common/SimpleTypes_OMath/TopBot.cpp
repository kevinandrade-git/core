...
{
    template<ETopBot eDefValue>
    CTopBot<eDefValue>::CTopBot() {}

    template<ETopBot eDefValue>
    ETopBot CTopBot<eDefValue>::FromString(std::wstring &sValue)
    {
    ...
    template<ETopBot eDefValue>
    std::wstring CTopBot<eDefValue>::ToString() const
    {
