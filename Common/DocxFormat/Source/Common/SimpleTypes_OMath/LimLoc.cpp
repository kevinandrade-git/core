...
{
    template<ELimLoc eDefValue>
    CLimLoc<eDefValue>::CLimLoc() {}

    template<ELimLoc eDefValue>
    ELimLoc CLimLoc<eDefValue>::FromString(std::wstring &sValue)
    {
    ...
    template<ELimLoc eDefValue>
    std::wstring CLimLoc<eDefValue>::ToString() const
    {
