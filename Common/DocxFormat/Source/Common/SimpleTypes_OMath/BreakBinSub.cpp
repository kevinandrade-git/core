...
{
    template<EBreakBinSub eDefValue>
    CBreakBinSub<eDefValue>::CBreakBinSub() {}

    template<EBreakBinSub eDefValue>
    EBreakBinSub CBreakBinSub<eDefValue>::FromString(std::wstring &sValue)
    {
    ...
    template<EBreakBinSub eDefValue>
    std::wstring CBreakBinSub<eDefValue>::ToString() const
    {
