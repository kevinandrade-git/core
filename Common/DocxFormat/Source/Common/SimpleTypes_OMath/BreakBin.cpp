...
{
    template<EBreakBin eDefValue>
    CBreakBin<eDefValue>::CBreakBin() {}

    template<EBreakBin eDefValue>
    EBreakBin CBreakBin<eDefValue>::FromString(std::wstring &sValue)
    {
    ...
    template<EBreakBin eDefValue>
    std::wstring CBreakBin<eDefValue>::ToString() const
    {
