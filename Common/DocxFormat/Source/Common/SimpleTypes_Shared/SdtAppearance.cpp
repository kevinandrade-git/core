...
{
    template<ESdtAppearance eDefValue>
    CSdtAppearance<eDefValue>::CSdtAppearance() {}

    template<ESdtAppearance eDefValue>
    ESdtAppearance CSdtAppearance<eDefValue>::FromString(std::wstring &sValue)
    {
    ...
    template<ESdtAppearance eDefValue>
    std::wstring CSdtAppearance<eDefValue>::ToString() const
    {
