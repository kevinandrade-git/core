...
{
    template<ETrueFalse eDefValue>
    CTrueFalse<eDefValue>::CTrueFalse() {}

    template<ETrueFalse eDefValue>
    ETrueFalse CTrueFalse<eDefValue>::FromString(std::wstring &sValue)
    {
    ...
    template<ETrueFalse eDefValue>
    bool CTrueFalse<eDefValue>::GetBool()
    {
        return this->m_eValue == booleanTrue;
    }

    template<ETrueFalse eDefValue>
    std::wstring CTrueFalse<eDefValue>::ToString() const
    {
