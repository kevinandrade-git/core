...
{
    template<EVerticalAlignRun eDefValue>
    CVerticalAlignRun<eDefValue>::CVerticalAlignRun() {}

    template<EVerticalAlignRun eDefValue>
    EVerticalAlignRun CVerticalAlignRun<eDefValue>::FromString(std::wstring &sValue)
    {
    ...
    template<EVerticalAlignRun eDefValue>
    std::wstring CVerticalAlignRun<eDefValue>::ToString() const
    {
