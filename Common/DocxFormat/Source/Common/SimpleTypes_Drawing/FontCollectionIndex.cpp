...
{
    template<EFontCollectionIndex eDefValue>
    CFontCollectionIndex<eDefValue>::CFontCollectionIndex() {}

    template<EFontCollectionIndex eDefValue>
    EFontCollectionIndex CFontCollectionIndex<eDefValue>::FromString(std::wstring &sValue)
    {
    ...
    template<EFontCollectionIndex eDefValue>
    std::wstring CFontCollectionIndex<eDefValue>::ToString() const
    {
