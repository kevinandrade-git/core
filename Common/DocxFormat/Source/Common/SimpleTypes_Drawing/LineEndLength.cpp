...
{
    template<ELineEndLength eDefValue>
    CLineEndLength<eDefValue>::CLineEndLength() {}

    template<ELineEndLength eDefValue>
    ELineEndLength CLineEndLength<eDefValue>::FromString(std::wstring &sValue)
    {
    ...
    template<ELineEndLength eDefValue>
    std::wstring CLineEndLength<eDefValue>::ToString() const
    {
