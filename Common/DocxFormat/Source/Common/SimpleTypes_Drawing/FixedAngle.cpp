...
namespace SimpleTypes
{
    ...
    CFixedAngle<nDefValue>::CFixedAngle() {}

    template<int nDefValue>
    void CFixedAngle<nDefValue>::SetValue(int nValue)
    {
        this->m_eValue = (std::min)( 5400000, (std::max)( -5400000, nValue ) );
    }

    template<int nDefValue>
    int CFixedAngle<nDefValue>::FromString(std::wstring &sValue)
    {
    ...
    template<int nDefValue>
    std::wstring CFixedAngle<nDefValue>::ToString() const
    {
    ...
    template<int nDefValue>
    double CFixedAngle<nDefValue>::GetAngle() const
    {
