...
{
    template<EPathShadeType eDefValue>
    CPathShadeType<eDefValue>::CPathShadeType() {}

    template<EPathShadeType eDefValue>
    EPathShadeType CPathShadeType<eDefValue>::FromString(std::wstring &sValue)
    {
    ...
    template<EPathShadeType eDefValue>
    std::wstring CPathShadeType<eDefValue>::ToString() const
    {
