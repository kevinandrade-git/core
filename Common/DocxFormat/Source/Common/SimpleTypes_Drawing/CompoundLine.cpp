...
{
    template<ECompoundLine eDefValue>
    CCompoundLine<eDefValue>::CCompoundLine() {}

    template<ECompoundLine eDefValue>
    ECompoundLine CCompoundLine<eDefValue>::FromString(std::wstring &sValue)
    {
    ...
    template<ECompoundLine eDefValue>
    std::wstring CCompoundLine<eDefValue>::ToString() const
    {
