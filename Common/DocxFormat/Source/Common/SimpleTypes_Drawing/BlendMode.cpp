...
{
    template<EBlendMode eDefValue>
    CBlendMode<eDefValue>::CBlendMode() {}

    template<EBlendMode eDefValue>
    EBlendMode CBlendMode<eDefValue>::FromString(std::wstring &sValue)
    {
    ...
    template<EBlendMode eDefValue>
    std::wstring CBlendMode<eDefValue>::ToString() const
    {
