...
namespace SimpleTypes
{
    ...
    CFOVAngle<nDefValue>::CFOVAngle() {}

    template<int nDefValue>
    void CFOVAngle<nDefValue>::SetValue(int nValue)
    {
        this->m_eValue = (std::min)( 10800000, (std::max)( 0, nValue ) );
    }

    template<int nDefValue>
    int CFOVAngle<nDefValue>::FromString(std::wstring &sValue)
    {
    ...
    template<int nDefValue>
    std::wstring CFOVAngle<nDefValue>::ToString() const
    {
    ...
    template<int nDefValue>
    double CFOVAngle<nDefValue>::GetAngle() const
    {
