...
{
    template<EAnimationDgmOnlyBuildType eDefValue>
    CAnimationDgmOnlyBuildType<eDefValue>::CAnimationDgmOnlyBuildType() {}

    template<EAnimationDgmOnlyBuildType eDefValue>
    EAnimationDgmOnlyBuildType CAnimationDgmOnlyBuildType<eDefValue>::FromString(std::wstring &sValue)
    {
    ...
    template<EAnimationDgmOnlyBuildType eDefValue>
    std::wstring CAnimationDgmOnlyBuildType<eDefValue>::ToString() const
    {
