...
{
    template<EPresetLineDashVal eDefValue>
    CPresetLineDashVal<eDefValue>::CPresetLineDashVal() {}

    template<EPresetLineDashVal eDefValue>
    EPresetLineDashVal CPresetLineDashVal<eDefValue>::FromString(std::wstring &sValue)
    {
    ...
    template<EPresetLineDashVal eDefValue>
    std::wstring CPresetLineDashVal<eDefValue>::ToString() const
    {
