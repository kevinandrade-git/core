...
{
    template<EAnimationChartOnlyBuildType eDefValue>
    CAnimationChartOnlyBuildType<eDefValue>::CAnimationChartOnlyBuildType() {}

    template<EAnimationChartOnlyBuildType eDefValue>
    EAnimationChartOnlyBuildType CAnimationChartOnlyBuildType<eDefValue>::FromString(std::wstring &sValue)
    {
    ...
    template<EAnimationChartOnlyBuildType eDefValue>
    std::wstring CAnimationChartOnlyBuildType<eDefValue>::ToString() const
    {
