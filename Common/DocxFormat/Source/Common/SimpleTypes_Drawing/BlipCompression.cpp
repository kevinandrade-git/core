...
{
    template<EBlipCompression eDefValue>
    CBlipCompression<eDefValue>::CBlipCompression() {}

    template<EBlipCompression eDefValue>
    EBlipCompression CBlipCompression<eDefValue>::FromString(std::wstring &sValue)
    {
    ...
    template<EBlipCompression eDefValue>
    std::wstring CBlipCompression<eDefValue>::ToString() const
    {
