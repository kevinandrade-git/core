...
{
    template<EPenAlignment eDefValue>
    CPenAlignment<eDefValue>::CPenAlignment() {}

    template<EPenAlignment eDefValue>
    EPenAlignment CPenAlignment<eDefValue>::FromString(std::wstring &sValue)
    {
    ...
    template<EPenAlignment eDefValue>
    std::wstring CPenAlignment<eDefValue>::ToString() const
    {
