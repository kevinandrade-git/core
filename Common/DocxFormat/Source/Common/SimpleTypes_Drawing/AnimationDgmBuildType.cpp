...
{
    template<EAnimationDgmBuildType eDefValue>
    CAnimationDgmBuildType<eDefValue>::CAnimationDgmBuildType() {}

    template<EAnimationDgmBuildType eDefValue>
    EAnimationDgmBuildType CAnimationDgmBuildType<eDefValue>::FromString(std::wstring &sValue)
    {
    ...
    template<EAnimationDgmBuildType eDefValue>
    std::wstring CAnimationDgmBuildType<eDefValue>::ToString() const
    {
