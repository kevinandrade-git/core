...
{
    template<ELineCap eDefValue>
    CLineCap<eDefValue>::CLineCap() {}

    template<ELineCap eDefValue>
    ELineCap CLineCap<eDefValue>::FromString(std::wstring &sValue)
    {
    ...
    template<ELineCap eDefValue>
    std::wstring CLineCap<eDefValue>::ToString() const
    {
