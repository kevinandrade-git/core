...
{
    template<EFtnPos eDefValue>
    CFtnPos<eDefValue>::CFtnPos() {}

    template<EFtnPos eDefValue>
    EFtnPos CFtnPos<eDefValue>::FromString(std::wstring &sValue)
    {
    ...
    template<EFtnPos eDefValue>
    std::wstring CFtnPos<eDefValue>::ToString  () const
    {
