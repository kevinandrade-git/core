...
{
    template<EFtnEdn eDefValue>
    CFtnEdn<eDefValue>::CFtnEdn() {}

    template<EFtnEdn eDefValue>
    EFtnEdn CFtnEdn<eDefValue>::FromString(std::wstring &sValue)
    {
    ...
    template<EFtnEdn eDefValue>
    std::wstring CFtnEdn<eDefValue>::ToString  () const
    {
