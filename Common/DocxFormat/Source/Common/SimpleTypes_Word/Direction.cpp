...
{
    template<EDirection eDefValue>
    CDirection<eDefValue>::CDirection() {}

    template<EDirection eDefValue>
    EDirection CDirection<eDefValue>::FromString(std::wstring &sValue)
    {
    ...
    template<EDirection eDefValue>
    std::wstring CDirection<eDefValue>::ToString() const
    {
