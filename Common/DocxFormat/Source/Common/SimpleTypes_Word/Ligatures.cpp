...
{
    template<ELigatures eDefValue>
    CLigatures<eDefValue>::CLigatures() {}

    template<ELigatures eDefValue>
    ELigatures CLigatures<eDefValue>::FromString(std::wstring &sValue)
    {
    ...
    template<ELigatures eDefValue>
    std::wstring CLigatures<eDefValue>::ToString() const
    {
